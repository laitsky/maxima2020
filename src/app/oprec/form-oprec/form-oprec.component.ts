...
export class FormOprecComponent implements OnInit {
  ...
  Prodi: Array<string> = ['Informatika', 'Teknik Komputer', 'Teknik Elektro', 'Teknik Fisika', 'Sistem Informasi',
    'Manajemen', 'Akuntansi', 'Komunikasi Strategis', 'Jurnalistik', 'Desain Komunikasi Visual', 'Arsitektur', 'Film', 'Perhotelan'];
  Angkatan: Array<string> = ['2017', '2018', '2019'];
  Divisi: Array<string> = ['A', 'B', 'C', 'D', 'E'];
